# This Makefile is for the Mojolicious::Plugin::RouteAccess extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Mojolicious/Plugin/RouteAccess.pm]
#     AUTHOR => [q[Dmitry E. Oboukhov <unera@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Mojolicious::Plugin::RouteAccess]
#     PREREQ_PM => { Mojolicious=>q[5] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Mojolicious/Plugin/RouteAccess.pm]
...
NAME_SYM = Mojolicious_Plugin_RouteAccess
VERSION = 0.01
...
MAKE = make
FULLEXT = Mojolicious/Plugin/RouteAccess
BASEEXT = RouteAccess
...
TO_INST_PM = lib/Mojolicious/Plugin/RouteAccess.pm

PM_TO_BLIB = lib/Mojolicious/Plugin/RouteAccess.pm \
	blib/lib/Mojolicious/Plugin/RouteAccess.pm
...
DISTNAME = Mojolicious-Plugin-RouteAccess
DISTVNAME = Mojolicious-Plugin-RouteAccess-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Dmitry E. Oboukhov <unera@>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Mojolicious-Plugin-RouteAccess' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Mojolicious: '\''5'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Dmitry E. Oboukhov <unera@>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Mojolicious-Plugin-RouteAccess",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Mojolicious" : "5"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Dmitry E. Oboukhov &lt;unera@&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Mojolicious::" VERSION="5" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Mojolicious/Plugin/RouteAccess.pm blib/lib/Mojolicious/Plugin/RouteAccess.pm 
